{self, ...}: {
  ...
  # peer; speed.jeiang.dev (modules/nixos/edge) fronts legion-node1's
  ...
  # netbird interface is already trusted (modules/nixos/netbird.nix).
  flake.nixosModules.speedtest = {
    config,
    lib,
    ...
  }: let

{self, ...}: {
  ...
  in {
    ...
    # for the proxy bouncer (not consumed here). Operator fills these via
    # `just sops-edit` before first deploy (sops-nix only checks at
    # activation time, not eval time, so it's safe to land the module

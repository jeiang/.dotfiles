...
- No email sends. If mail access is ever wired in, drafting is free;
  sending is not — show Aidan the recipient, subject, and body and wait
  for an explicit yes, every time.
